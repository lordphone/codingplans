...
@Component({
  ...
  template: `
    <div class="flex flex-wrap items-center justify-end gap-2">
      ...
      <button
        type="button"
        class="rounded-none border border-zinc-300 bg-white px-2.5 py-1 font-mono text-[10px] font-medium uppercase tracking-wide text-zinc-700 shadow-sm transition-colors hover:border-emerald-600 hover:text-emerald-800 disabled:cursor-not-allowed disabled:opacity-50"
